class Exercise1
{
    ...
    {
        string tsvFileName = "/Users/alex/RiderProjects/proa/ConsoleApp1/sheet.tsv";
        ...
        using (StreamReader reader = new StreamReader(tsvFileName))
        {
            ...
            {
                List<String> columns = new List<string>(line.Split('\t')); // Use '\t' as the tab delimiter
                if (isFirstTime)
                {
